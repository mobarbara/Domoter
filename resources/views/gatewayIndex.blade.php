    ...
    <div id="app">
        ...
        <main class="py-4">
            <div class="container">
            			...
            			<div class="card">
               			...
               			<div class="card-body">	
                        		...
                        		<table class="table"> 
                                    ...
                                    <tr>
                                        <td><a href="/app/gateway/{{$gateway->id}}/device">{{$gateway->id}}</a></td>
                                        <td>{{$gateway->mqtt_server}}</td>
                                        <td>{{$gateway->mqtt_port}}</td>
                                        <td><button onclick="location='/gateway/edit/{{$gateway->id}}'"><a> Edit </a></button></td>
                                        <td><button onclick="location='/gateway/delete/{{$gateway->id}}'"><a> Delete </a></button></td>
                                    </tr>
                                		@endforeach                  
                        		</table>
                    			</div>
    			   ...
    			   <form method="post" action="/add/gateway">
